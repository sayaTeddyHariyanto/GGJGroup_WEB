<script>
    ...
    $(document).ready(function() {
        $("#show").on('click', function(event) {
            ...
            if($('#password, #repassword, #passlama').attr("type") == "text"){
                $('#password, #repassword, #passlama').attr('type', 'password');
                $('#icon').addClass( "fa-eye-slash" );
                $('#icon').removeClass( "fa-eye" );
            }else if($('#password, #repassword, #passlama').attr("type") == "password"){
                $('#password, #repassword, #passlama').attr('type', 'text');
