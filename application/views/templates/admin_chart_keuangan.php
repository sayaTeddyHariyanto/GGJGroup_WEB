...
<?php if(isset($pembayaran)){ ?>
    ...
    foreach ($pembayaran as $data) {
        $bulanPembayaran = substr($data->tanggal_zakat, 0, 7);
        ...
        $tgl_distribusi[] = $bulanPembayaran;
        $total[] = (float) $saldo;
    }
    ?>
    var ctx = document.getElementById("laporanArea");
    var myLineChart = new Chart(ctx, {
    type: 'line',
    data: {
        labels: <?php echo json_encode($tgl_distribusi); ?>,
        datasets: [{
        label: "Total ",
        lineTension: 0.3,
