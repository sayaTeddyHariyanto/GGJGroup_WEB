                        ...
                        <div class="card-body px-5">
                            ...
                            <table class="table table-sm table-borderless">
                                <tbody>
                                    ...
                                    <tr>
                                        <th width="350px" class="text-right">Id Anggota</th>
                                        <td>:</td>
                                        <td><?= $detDaftar->id_anggota ?></td>
                                    </tr>
                                </tbody>
                            </table>
                            <hr>
                            <div class="text-center">
                                ...
                                <a href="<?= base_url() ?>user/history_pendaftaran/printpdf" class="btn btn-sm btn-primary mb-3"><i class="fas fa-file-pdf fa-sm mr-2"></i>Cetak Bukti</a>
