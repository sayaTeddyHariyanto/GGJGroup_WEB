...
class M_distribusi extends CI_Model
{
    ...
    {
        $query = $this->db->query("SELECT id_distribusi, tb_kategori.nama_kategori, judul_distribusi, tanggal_distribusi, status_distribusi, SUM(nominal_distribusi) AS Total_distribusi FROM distribusi_zakat, tb_kategori WHERE distribusi_zakat.id_kategori=tb_kategori.id_kategori AND distribusi_zakat.status_distribusi = 1 AND distribusi_zakat.tanggal_distribusi BETWEEN '$t_awal' AND '$t_akhir' GROUP BY tanggal_distribusi ORDER BY distribusi_zakat.tanggal_distribusi ASC
        ");
        return $query;
    }
    ...
    {
        $query = $this->db->query("SELECT id_distribusi, tb_kategori.nama_kategori, judul_distribusi, tanggal_distribusi, status_distribusi, SUM(nominal_distribusi) AS Total_distribusi FROM distribusi_zakat, tb_kategori WHERE distribusi_zakat.id_kategori=tb_kategori.id_kategori AND distribusi_zakat.status_distribusi = 1 AND distribusi_zakat.tanggal_distribusi LIKE '%$bulan%' GROUP BY day(tanggal_distribusi) ORDER BY distribusi_zakat.tanggal_distribusi ASC
        ");
        return $query;
    }
    ...
    {
        $query = $this->db->query("SELECT id_distribusi, tb_kategori.nama_kategori, judul_distribusi, tanggal_distribusi, status_distribusi, SUM(nominal_distribusi) AS Total_distribusi FROM distribusi_zakat, tb_kategori WHERE distribusi_zakat.id_kategori=tb_kategori.id_kategori AND distribusi_zakat.status_distribusi = 1 AND distribusi_zakat.tanggal_distribusi LIKE '%$tahun%' GROUP BY month(tanggal_distribusi) ORDER BY distribusi_zakat.tanggal_distribusi ASC
        ");
        return $query;
    }
}
